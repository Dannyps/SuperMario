...
public class Plant extends Enemy {
    ...
    protected void defineEnemy() {
        ...
        bodyd.position.set(getX()/ MainClass.PPM + 9 / MainClass.PPM ,getY()/ MainClass.PPM + 4/ MainClass.PPM  );
        ...
        vertice[0] = new Vector2(-9 / MainClass.PPM, 9 / MainClass.PPM);
        vertice[1] = new Vector2(9 / MainClass.PPM, 9/ MainClass.PPM);
        vertice[2] = new Vector2(-9f / MainClass.PPM, 0 / MainClass.PPM);
        vertice[3] = new Vector2(9f / MainClass.PPM, 0/ MainClass.PPM);
        head.set(vertice);
        fixtured.shape = head;

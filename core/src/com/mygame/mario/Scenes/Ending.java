...
public class Ending implements Screen {
    ...
    public Ending(MainClass menu) {
        this.menu = menu;
        this.stage = new Stage();
        this.background = new TextureRegion(new Texture("you_lose.jpg"), 0, 0, 768, 432);
        playGame = new TextButton("Retry", new Skin(Gdx.files.internal("Skins/flat-earth/skin/flat-earth-ui.json")));
        loadButton(playGame);
    }
